...
import { createProjectPartsExternalLinkValidationSchema } from '@my/api/src/validationSchemas/projectPartsExternalLink'

import { getExternalLinkUrlType } from '@my/api/src/utils/externalLinkType'
