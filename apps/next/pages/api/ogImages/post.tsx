...
import { Comment, LicensePlateLogo, Like } from '@my/ui'

const rubikBoldFont = fetch(new URL('@my/fonts/Rubik-Bold.ttf', import.meta.url)).then(
  res => res.arrayBuffer(),
)

const rubikRegularFont = fetch(new URL('@my/fonts/Rubik-Regular.ttf', import.meta.url)).then(
  res => res.arrayBuffer(),
)
